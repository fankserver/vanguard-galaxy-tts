...
internal sealed class BarRosterBridge : IDisposable
{
    ...
    private BarRosterBridge(PropertyInfo bars, object service) { _bars = bars; _service = service; }
    ...
    internal static void Start()
    {
        try
        {
            ...
            if (property == null || service == null || api == null || snapshot == null) return;
            ...
            var bridge = new BarRosterBridge(property, service);
